...
/**
 * Basic Strategy Tables for H17 (Dealer Hits Soft 17) with DAS (Double After Split)
 * This is the most common casino rule set
 */

export const HARD_HAND_STRATEGY_H17_DAS: Record<string, StrategyAction> = {
  ...
  // Hard 11: Double on all (H17 rule: double vs Ace)
  ...
  // Hard 13-16: Stand on 2-6, else hit (with surrender on 15/16 vs 10/A for H17)
  ...
  '15_vs_2': 'S', '15_vs_3': 'S', '15_vs_4': 'S', '15_vs_5': 'S', '15_vs_6': 'S', '15_vs_7': 'H', '15_vs_8': 'H', '15_vs_9': 'H', '15_vs_10': 'SU', '15_vs_A': 'SU', // H17: surrender vs A
...
export const SOFT_HAND_STRATEGY_H17_DAS: Record<string, StrategyAction> = {
  ...
  // Soft 18 (A,7): Double on 2-6, stand on 7/8, hit on 9/10/A (H17: hit vs 2)
  'A7_vs_2': 'DS', 'A7_vs_3': 'DS', 'A7_vs_4': 'DS', 'A7_vs_5': 'DS', 'A7_vs_6': 'DS', 'A7_vs_7': 'S', 'A7_vs_8': 'S', 'A7_vs_9': 'H', 'A7_vs_10': 'H', 'A7_vs_A': 'H',
...
export const PAIR_STRATEGY_H17_DAS: Record<string, StrategyAction> = {
  // 2,2 and 3,3: Split on 2-7, else hit (DAS allows more aggressive splitting)
