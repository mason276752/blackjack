...
// Format: "playerValue_vs_dealerCard" -> Action

export const HARD_HAND_STRATEGY: Record<string, StrategyAction> = {
  ...
  // Hard 13-16: Stand on 2-6, else hit
  ...
  '15_vs_2': 'S', '15_vs_3': 'S', '15_vs_4': 'S', '15_vs_5': 'S', '15_vs_6': 'S', '15_vs_7': 'H', '15_vs_8': 'H', '15_vs_9': 'H', '15_vs_10': 'SU', '15_vs_A': 'H',
...
export const SOFT_HAND_STRATEGY: Record<string, StrategyAction> = {
...
export const PAIR_STRATEGY: Record<string, StrategyAction> = {
  // 2,2 and 3,3: Split on 2-7, else hit
